                    ...
                    <div class="col-md-12">
                        <form action="#" method="post">
                            <div class="form-group" style="display:flex; align-items: center; margin-bottom:0;">
                                <label for="exampleInputFile" class="custom-file-label"><i
                                        class="fa fa-file"></i>&nbsp;&nbsp;Seleccionar archivo</label>
                                <input type="file" id="exampleInputFile" class="custom-file-label"
